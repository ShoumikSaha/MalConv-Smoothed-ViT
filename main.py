...
if __name__ == '__main__':
    ...
    #train_model(model, input_file_list, ab_len=50000, epoch=10)


    model = tf.keras.models.load_model('saved/my_train/vit_model.h5')
    correct = 0
    for file in os.listdir('FullDataset/output/adv_malware'):
        pred_class = run_model_ablation(model, 'FullDataset/output/adv_malware/' + file, 1.0, ab_len=20000)
